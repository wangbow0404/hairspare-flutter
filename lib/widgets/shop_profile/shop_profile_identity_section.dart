...
/// 샵 프로필 — 아바타 · 이름 · 이메일 · 프로필 수정 버튼.
class ShopProfileIdentitySection extends StatelessWidget {
  const ShopProfileIdentitySection({super.key});
    ...
    return Container(
      ...
      child: Consumer<AuthProvider>(
        builder: (context, authProvider, _) {
          ...
          final displayName = user?.name ?? user?.username ?? '미용실';
            ...
            children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: user?.profileImage != null
                            ...
                            : Center(
                                child: IconMapper.icon('storefront', size: 40, color: Colors.white) ??
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            ShopProfileNavigation.pushProfileEdit(context).then((_) {
                              if (context.mounted) {
                                context.read<ShopProfileViewModel>().loadInitial();
                              }
                            });
                          },
                          child: Container(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => ShopProfileNavigation.pushProfileEdit(context),
                  ...
                  child: Row(
                    ...
                    children: [
                      IconMapper.icon('storefront', size: 16, color: AppTheme.textGray700) ??
                          const Icon(Icons.storefront, size: 16, color: AppTheme.textGray700),
                      const SizedBox(width: AppTheme.spacing2),
                      Text(
                        '프로필 수정',
