...
class RegionHelper {
  ...
  static final List<Region> _regions = [
    // 시/도
    const Region(id: 'seoul', name: '서울', type: RegionType.province),
    const Region(id: 'busan', name: '부산', type: RegionType.province),
    const Region(id: 'daegu', name: '대구', type: RegionType.province),
    const Region(id: 'incheon', name: '인천', type: RegionType.province),
    const Region(id: 'gwangju', name: '광주', type: RegionType.province),
    const Region(id: 'daejeon', name: '대전', type: RegionType.province),
    const Region(id: 'ulsan', name: '울산', type: RegionType.province),
    const Region(id: 'gyeonggi', name: '경기', type: RegionType.province),
    const Region(id: 'gangwon', name: '강원', type: RegionType.province),
    const Region(id: 'chungbuk', name: '충북', type: RegionType.province),
    const Region(id: 'chungnam', name: '충남', type: RegionType.province),
    const Region(id: 'jeonbuk', name: '전북', type: RegionType.province),
    const Region(id: 'jeonnam', name: '전남', type: RegionType.province),
    const Region(id: 'gyeongbuk', name: '경북', type: RegionType.province),
