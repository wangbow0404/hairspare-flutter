  ...
  static final List<Map<String, dynamic>> _chatsJson = [
    {
      ...
      'shopId': 'mock-shop-1',
      'shopName': '빌라드블랑 강남점',
      'shopProfileImage': _mockImage('shop/mock-shop-1'),
    ...
    },
    {
      ...
      'shopId': 'shop-2',
      'shopName': '헤어스튜디오 A',
      'shopProfileImage': _mockImage('shop/shop-2'),
      'spareId': 'mock-spare-1',
      'spareName': '김디자이너',
      'jobId': 'job-mock-2',
      'jobTitle': '주말 디자이너 대타',
    ...
    },
    {
      ...
      'shopId': 'shop-3',
      'shopName': '빌라드블랑 홍대점',
      'shopProfileImage': _mockImage('shop/shop-3'),
      'spareId': 'mock-spare-1',
      'spareName': '김디자이너',
      'jobId': 'job-mock-3',
      'jobTitle': '금요일 저녁 급구',
    ...
    },
    {
      ...
      'shopId': 'shop-4',
      'shopName': '헤어살롱 B',
      'shopProfileImage': _mockImage('shop/shop-4'),
      'spareId': 'mock-spare-1',
      'spareName': '김디자이너',
      'jobId': 'job-mock-4',
      'jobTitle': '오전 스텝',
    ...
    },
    {
      ...
      'shopId': 'shop-5',
      'shopName': '스타일리스트 C',
      'shopProfileImage': _mockImage('shop/shop-5'),
      'spareId': 'mock-spare-1',
      'spareName': '김디자이너',
      'jobId': 'job-mock-5',
      'jobTitle': '주중 디자이너',
    ...
    },
    {
      ...
      'shopId': 'shop-6',
      'shopName': '커트 전문샵',
      'shopProfileImage': _mockImage('shop/shop-6'),
      'spareId': 'mock-spare-1',
      'spareName': '김디자이너',
      'jobId': 'job-mock-6',
      'jobTitle': '오후 시간대 대타',
