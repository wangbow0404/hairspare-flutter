...
abstract final class MockModelHomeData {
  static ModelHomeProfileSummary profileForUser(
    User? user, {
    int? todayInterestCount,
  }) {
    ...
    return ModelHomeProfileSummary(
      ...
      todayInterestCount:
          todayInterestCount ?? MockMatchingData.pendingCountForModel(),
      matchingVisible: true,
    );
  }

  static List<ModelHomeInterest> get interests =>
